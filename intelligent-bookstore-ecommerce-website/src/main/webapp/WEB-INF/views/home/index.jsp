...
<html>
  ...
  <body>
          ...
          <div class="row g-0">
            ...
            <div class="col-md-4 border-start border-end">
              <p class="fs-6 my-2 text-center">
                ...
                <a class="text-decoration-underline" href="user/home"
                  >Shop Now</a
                >
              </p>
            </div>
                              ...
                              <div class="tab-content" id="nav-tabContent">
                                ...
                                >
                                  ...
                                  <div class="form-group pb-3">
                                    <%--@declare id="sign-in"--%><label class="mb-2" for="sign-in"
                                      >Password *</label
                                    >
                                    <input
                                      type="password"
                                ...
                                >
                                  <div class="form-group py-3">
                                    <%--@declare id="register"--%><label class="mb-2" for="register"
              ...
              >
                ...
                >
                  <div class="banner-content">
                    ...
                    <a href="index.jsp" class="btn mt-3">Shop Collection</a>
                  </div>
                </div>
              ...
              >
                ...
                >
                  <div class="banner-content">
                    ...
                    <a href="index.jsp" class="btn mt-3">Shop Product</a>
                  </div>
                </div>
                <div class="col-md-6 text-center">
                  <div class="image-holder">
    ...
    <section id="best-selling-items-1" class="position-relative padding-large">
      <div class="container">
        <div
          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <div class="card position-relative p-4 border rounded-3">
                ...
                <img
                  src="../../../static/images/product-item1.png"
            ...
            <div class="swiper-slide">
              <div class="card position-relative p-4 border rounded-3">
                <img
                  src="../../../static/images/product-item2.png"
                  class="img-fluid shadow-sm"
                  alt="product item"
                />
                <h6 class="mt-4 mb-0 fw-bold">
            ...
            <div class="swiper-slide">
              <div class="card position-relative p-4 border rounded-3">
                <img
                  src="../../../static/images/product-item3.png"
                  class="img-fluid shadow-sm"
                  alt="product item"
                />
                <h6 class="mt-4 mb-0 fw-bold">
            ...
            <div class="swiper-slide">
              <div class="card position-relative p-4 border rounded-3">
                ...
                <img
                  src="../../../static/images/product-item4.png"
                  class="img-fluid shadow-sm"
                  alt="product item"
                />
                <h6 class="mt-4 mb-0 fw-bold">
            ...
            <div class="swiper-slide">
              <div class="card position-relative p-4 border rounded-3">
                <img
                  src="../../../static/images/product-item5.png"
                  class="img-fluid shadow-sm"
                  alt="product item"
                />
                <h6 class="mt-4 mb-0 fw-bold">
            ...
            <div class="swiper-slide">
              <div class="card position-relative p-4 border rounded-3">
                <img
                  src="../../../static/images/product-item6.png"
                  class="img-fluid shadow-sm"
                  alt="product item"
                />
                <h6 class="mt-4 mb-0 fw-bold">
                ...
                <div class="item d-flex">
                  ...
                  <div class="item-content ms-3">
                    ...
                    <div class="review-content d-flex">
                      ...
                      <div
                        class="rating text-warning d-flex align-items-center"
                      >
                        <svg class="star star-fill">
                          <use xlink:href="#star-fill"></use>
                        </svg>
          ...
          <div class="col-md-6 mb-4 mb-lg-0 col-lg-3">
            <div class="best-reviewed border rounded-3 p-4">
              ...
              <div class="items-lists">
                <div class="item d-flex">
                  <img
                    src="../../../static/images/product-item7.png"
                    class="img-fluid shadow-sm"
                    alt="product item"
                  />
                  <div class="item-content ms-3">
                ...
                <div class="item d-flex">
                  <img
                    src="../../../static/images/product-item8.png"
                    class="img-fluid shadow-sm"
                    alt="product item"
                  />
                  <div class="item-content ms-3">
                ...
                <div class="item d-flex">
                  <img
                    src="../../../static/images/product-item9.png"
                    class="img-fluid shadow-sm"
                    alt="product item"
                  />
                  <div class="item-content ms-3">
          ...
          <div class="col-md-6 mb-4 mb-lg-0 col-lg-3">
            <div class="on-sale border rounded-3 p-4">
              ...
              <div class="items-lists">
                <div class="item d-flex">
                  <img
                    src="../../../static/images/product-item10.png"
                    class="img-fluid shadow-sm"
                    alt="product item"
                  />
                  <div class="item-content ms-3">
                ...
                <div class="item d-flex">
                  <img
                    src="../../../static/images/product-item11.png"
                    class="img-fluid shadow-sm"
                    alt="product item"
                  />
                  <div class="item-content ms-3">
                ...
                <div class="item d-flex">
                  <img
                    src="../../../static/images/product-item12.png"
                    class="img-fluid shadow-sm"
                    alt="product item"
                  />
                  <div class="item-content ms-3">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-3 posts mb-4">
            ...
            <h4 class="card-title mb-2 text-capitalize text-dark"><a href="index.jsp">10 Must-Read Books of the Year: Our Top Picks!</a></h4>
            <p class="mb-2">Dive into the world of cutting-edge technology with our latest blog post, where we highlight
              five essential gadge. <span><a class="text-decoration-underline text-black-50" href="index.jsp">Read More</a></span>
            </p>
          </div>
          <div class="col-md-3 posts mb-4">
            <img src="images/post-item2.jpg" alt="post image" class="img-fluid rounded-3">
            <a href="blog.html" class="fs-6 text-primary">Books</a>
            <h4 class="card-title mb-2 text-capitalize text-dark"><a href="index.jsp">The Fascinating Realm of Science Fiction</a></h4>
            <p class="mb-2">Explore the intersection of technology and sustainability in our latest blog post. Learn about
              the innovative <span><a class="text-decoration-underline text-black-50" href="index.jsp">Read More</a></span> </p>
          </div>
          <div class="col-md-3 posts mb-4">
            <img src="images/post-item3.jpg" alt="post image" class="img-fluid rounded-3">
            <a href="blog.html" class="fs-6 text-primary">Books</a>
            <h4 class="card-title mb-2 text-capitalize text-dark"><a href="index.jsp">Finding Love in the Pages of a Book</a></h4>
            <p class="mb-2">Stay ahead of the curve with our insightful look into the rapidly evolving landscape of
              wearable technology. <span><a class="text-decoration-underline text-black-50" href="index.jsp">Read More</a></span>
            </p>
          </div>
          <div class="col-md-3 posts mb-4">
            <img src="images/post-item4.jpg" alt="post image" class="img-fluid rounded-3">
            <a href="blog.html" class="fs-6 text-primary">Books</a>
            <h4 class="card-title mb-2 text-capitalize text-dark"><a href="index.jsp">Reading for Mental Health: How Books Can Heal and Inspire</a></h4>
            <p class="mb-2">In today's remote work environment, productivity is key. Discover the top apps and tools that
              can help you stay <span><a class="text-decoration-underline text-black-50" href="index.jsp">Read More</a></span>
            </p>
          </div>
        </div>
      </div>
          ...
          <div class="ship-and-payment d-flex gap-md-5 flex-wrap">
            <div class="shipping d-flex">
              ...
              <div class="card-wrap ps-2">
                <img src="../../../static/images/dhl.png" alt="visa" />
                <img src="../../../static/images/shippingcard.png" alt="mastercard" />
              </div>
            </div>
            <div class="payment-method d-flex">
              ...
              <div class="card-wrap ps-2">
                ...
                <img src="../../../static/images/mastercard.jpg" alt="mastercard" />
